...
while True:
    # get the direction of the submarine
    direction = input()
    # change the position of the submarine
    ...
    if matrix[s_row][s_col] == "*":
        # if the submarine is hit by a mine, change the symbol of the mine to '-' and increase the number of hited mines
        matrix[s_row][s_col] = "-"
        number_of_hited_mines += 1
    elif matrix[s_row][s_col] == "C":
        # if the submarine destroys a cruiser, change the symbol of the cruiser to '-' and increase the number of destroyed cruisers
        matrix[s_row][s_col] = "-"
    ...
    elif number_of_destroyed_cruisers == 3:
        # if the submarine destroys all the battle cruisers, print the message and break the loop
        print("Mission accomplished, U-9 has destroyed all battle cruisers of the enemy!")

    # if the game is over - break the loop
    if number_of_hited_mines == 3 or number_of_destroyed_cruisers == 3:
        break
    # change the symbol of the submarine to '-'
    # matrix[s_row][s_col] = "-"
