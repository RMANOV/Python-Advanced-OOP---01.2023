...
# removed_knights =[ int(x) for x in all_knights if matrix[x[0]][x[1]] == "K" and x[0] > 1 and x[1] > 1 and x[0] < rows_count - 2 and x[1] < rows_count - 2 and matrix[x[0] - 2][x[1] - 1] == "K" and matrix[x[0] - 2][x[1] + 1] == "K" and matrix[x[0] - 1][x[1] - 2] == "K" and matrix[x[0] - 1][x[1] + 2] == "K" and matrix[x[0] + 1][x[1] - 2] == "K" and matrix[x[0] + 1][x[1] + 2] == "K" and matrix[x[0] + 2][x[1] - 1] == "K" and matrix[x[0] + 2][x[1] + 1] == "K" ]
# removed_knights = [ x for x in all_knights if matrix[x[0]][x[1]] == "K" and x[0] > 1 and x[1] > 1 and x[0] < rows_count - 2 and x[1] < rows_count - 2 and matrix[x[0] - 2][x[1] - 1] == "K" and matrix[x[0] - 2][x[1] + 1] == "K" and matrix[x[0] - 1][x[1] - 2] == "K" and matrix[x[0] - 1][x[1] + 2] == "K" and matrix[x[0] + 1][x[1] - 2] == "K" and matrix[x[0] + 1][x[1] + 2] == "K" and matrix[x[0] + 2][x[1] - 1] == "K" and matrix[x[0] + 2][x[1] + 1] == "K" ]
...
for knight in all_knights:
    if knight[0] > 1 and knight[1] > 1 and knight[0] < rows_count - 2 and knight[1] < rows_count - 2:
        if matrix[knight[0] - 2][knight[1] - 1] == "K" and matrix[knight[0] - 2][knight[1] + 1] == "K" and matrix[knight[0] - 1][knight[1] - 2] == "K" and matrix[knight[0] - 1][knight[1] + 2] == "K" and matrix[knight[0] + 1][knight[1] - 2] == "K" and matrix[knight[0] + 1][knight[1] + 2] == "K" and matrix[knight[0] + 2][knight[1] - 1] == "K" and matrix[knight[0] + 2][knight[1] + 1] == "K":
            matrix[knight[0]][knight[1]] = "0"
            all_knights.remove(knight)
print(all_knights_count - len(all_knights))
