...
for _ in range(count_of_commands):
    ...
    if command[0] == "move":
        ...
        steps = int(command[2])
        if direction == "right":
            if position[1] + steps < 5 and field[position[0]][position[1] + steps] == ".":
                field[position[0]][position[1]] = "."
                position = (position[0], position[1] + steps)
                field[position[0]][position[1]] = "A"
        elif direction == "left":
            if position[1] - steps >= 0 and field[position[0]][position[1] - steps] == ".":
                field[position[0]][position[1]] = "."
                position = (position[0], position[1] - steps)
                field[position[0]][position[1]] = "A"
        elif direction == "up":
            if position[0] - steps >= 0 and field[position[0] - steps][position[1]] == ".":
                field[position[0]][position[1]] = "."
                position = (position[0] - steps, position[1])
                field[position[0]][position[1]] = "A"
        elif direction == "down":
            if position[0] + steps < 5 and field[position[0] + steps][position[1]] == ".":
                field[position[0]][position[1]] = "."
                position = (position[0] + steps, position[1])
                field[position[0]][position[1]] = "A"
